...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "angel.guiao@yahoo.com", ZipCode = "123"});
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("angel.guiao@yahoo.com","Forms"), null);
